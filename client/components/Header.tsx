...
function Header({ initialSelectedIcon }: HeaderProps) {
        ...
        <header className="relative w-full">
            <div className="px-4 py-3 sm:px-6 lg:px-8">
                <div className="flex items-center sm:justify-between sm:gap-4">
                    ...
                    <div
                        className="flex items-center justify-between flex-1 gap-8 sm:justify-end"
                    >
                        ...
                        >
                            ...
                            <p className="hidden ml-2 text-xs text-left sm:block">
                                ...
                                <span className="text-gray-500">@{currentAccount.slice(0, 6)}...{currentAccount.slice(39)}</span>
                            </p>
